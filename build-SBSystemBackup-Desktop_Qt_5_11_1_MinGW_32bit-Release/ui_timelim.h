...
public:
    ...
    void setupUi(QMainWindow *timelim)
    {
        ...
        addtimelim->setGeometry(QRect(90, 240, 121, 41));
        QFont font2;
    ...
    {
        timelim->setWindowTitle(QApplication::translate("timelim", "\344\277\256\346\224\271\346\227\266\351\227\264", nullptr));
