...
public:
    ...
    void setupUi(QMainWindow *admininfo)
    {
        ...
        promptpas->setGeometry(QRect(550, 170, 201, 16));
        newpasswd = new QLineEdit(centralwidget);
    ...
    {
        admininfo->setWindowTitle(QApplication::translate("admininfo", "\344\277\256\346\224\271\344\277\241\346\201\257", nullptr));
